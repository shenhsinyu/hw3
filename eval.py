...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default='weights/88_77.pth', type=str,
    ...
    parser.add_argument('--images', default='data/test_images:data/output', type=str,
...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=0.45, fps_str=''):
    ...
    with timer.env('Copy'):
        ...
        if cfg.eval_mask_branch:
            ...
            for i in range(masks.shape[0]):
                x = binary_mask_to_rle(masks[i,:,:].cpu().numpy())
                seg.append(x)
        ...
        json_file = {}
        json_file['score'] = scores.tolist()
        json_file['category_id'] = classes.tolist()
        json_file['segmentation'] = seg
        #print(json_file)
    ...
    if args.display_masks and cfg.eval_mask_branch and num_dets_to_consider > 0:
        ...
        #print(inv_alph_masks.cpu().numpy().shape)
        '''
        seg = []
        for i in range(inv_alph_masks.shape[0]):
            x = binary_mask_to_rle(inv_alph_masks[i,:,:,:].cpu().numpy())
            seg.append(x)
        '''   
        #print(seg)
...
def evalimage(net:Yolact, path:str, save_path:str=None):
    ...
    img_numpy, json_file = prep_display(preds, frame, None, None, undo_transform=False)
...
def evalimages(net:Yolact, input_folder:str, output_folder:str):
    ...
    for p in Path(input_folder).glob('*'): 
        ...
        json_file = evalimage(net, path, out_path)
        json_file['image_id'] = name[:-4]
        prediction_file.append(json_file)
        print(path + ' -> ' + out_path)
