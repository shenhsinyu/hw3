...
parser.add_argument('--resume', default='weights/88_77.pth', type=str,
...
def train():
    ...
    epoch_size = len(dataset) // args.batch_size #1349/6=224
    num_epochs = math.ceil(cfg.max_iter / epoch_size)#106666/224=4762
    #print(cfg.max_iter)
    #num_epochs = 10
